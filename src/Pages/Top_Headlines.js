...
const Top_Headlines = (props) => {
    ...
    const [apiUrl, setApiUrl] = useState(`https://newsapi.org/v2/top-headlines?q=a&page=${page}&pageSize=${pagesize}&apiKey=5f9bc8ef58444d9da5f5782b2ed7744b`); // State for the API URL
  ...
  const set_query=(z)=>{
    ...
    useEffect(()=>{
          let a=`https://newsapi.org/v2/top-headlines?q=v&page=${page}&pageSize=${pagesize}`
          if(countryfilter!=''){
